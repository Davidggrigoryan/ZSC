...
SubShader {
	...
	Pass {
		...
		#include "Assets/ZombieSoccer/Scripts/ExternalTools/TextMesh Pro/Shaders/TMPro_Properties.cginc"
		#include "Assets/ZombieSoccer/Scripts/ExternalTools/TextMesh Pro/Shaders/TMPro.cginc"
